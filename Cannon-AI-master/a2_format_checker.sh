...
# Run the code
python2 server.py 10000 -n 8 -m 8 -NC 2 -TL 90 -LOG server.log &
server_pid=$!
python2 client.py 0.0.0.0 10000 RandomPlayer.py > player1 &
client1_pid=$!
python2 client.py 0.0.0.0 10000 run.sh > player2 &
client2_pid=$!
